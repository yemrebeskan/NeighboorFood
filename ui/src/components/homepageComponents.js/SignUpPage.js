...
const SignUpPage = () => {
  ...
  {!passwordIsValid && <p className="error-text">Password should be at least 7 characters long.</p>}
  <br />
  <input
            className="input-class"
          ...
          />
          {enteredPassword !== enteredConfirmPassword && <p className="error-text">Passwords do not match.</p>}
          <br />
        ...
        {passwordIsValid && confirmPasswordIsValid && (
          <div className="strength-meter">
            ...
            <div class={`strength-meter__bar strength-meter__bar--${getPasswordStrength(
          enteredPassword
        )}`} />

          </div>
        )}
        <button type="submit" className = "button-class" disabled={!formIsValid}>Sign Up</button>
      </form>
    </div>
  );
}
